    ...
    <>
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 py-10 min-h-screen flex flex-col lg:flex-row gap-8 mt-6">
        ...
        <div className="lg:w-2/3">
          <h1 className="text-5xl font-sans font-bold mt-6 text-green-900 mb-4 ">
            Poetry Dictionary
          </h1>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
            ...
            <select
              ...
              className="w-full md:w-1/4 p-4 border-2 border-gray-300 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-green-500"
            >
            ...
            <button
              ...
              className="p-4 bg-green-600 text-white rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-green-500 w-full md:w-auto"
            >
              <FaSearch />
            </button>
          </div>
        ...
        <div className="lg:w-[70vh] bg-gradient-to-br from-green-100 to-green-200 p-6 rounded-xl shadow-md border border-gray-200 -mr-16">
